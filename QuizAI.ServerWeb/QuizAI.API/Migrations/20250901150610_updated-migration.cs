    ...
    public partial class updatedmigration : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Questions", x => new { x.QuizId, x.Order });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_UserAnswers_Questions_QuestionQuizId_QuestionOrder",
                        columns: x => new { x.QuestionQuizId, x.QuestionOrder },
                        principalTable: "Questions",
                        principalColumns: new[] { "QuizId", "Order" },
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserAnswers_QuestionQuizId_QuestionOrder",
                table: "UserAnswers",
                columns: new[] { "QuestionQuizId", "QuestionOrder" });

            migrationBuilder.CreateIndex(
                name: "IX_UserAnswers_QuizAttemptId_QuestionQuizId_QuestionOrder",
                table: "UserAnswers",
                columns: new[] { "QuizAttemptId", "QuestionQuizId", "QuestionOrder" },
                unique: true);
        }
